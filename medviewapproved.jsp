...
<title>Medical View Approved</title>
</head>
<style>
h2 {
...
Connection con;
       ...
       PreparedStatement ps=con.prepareStatement("SELECT * FROM disastermanagement.publiccomplaint p where status='Forward' AND status1='Approved' ");
     /*   
